...
function elite_shipping_customize_controls_enqueue_scripts() {
	...
	wp_add_inline_style(
		...
		. '.elite-blog-cards-list-item__title,.elite-blog-cards-list-item__intro{width:100%;max-width:100%;margin:2px 0;}'
		. '.elite-blog-paragraphs{margin:0 0 8px;}'
		...
		. '.elite-blog-section__cell{flex:0 0 42px;width:42px;min-width:42px;max-width:42px;margin:0;padding:0 4px;text-align:center;text-transform:lowercase;}'
